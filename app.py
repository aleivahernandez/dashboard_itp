    ...
    with st.container(border=True):
        ...
        if not df_filtrado_general.empty:
            ...
            if not df_radar.empty:
                ...
                fig_radar.update_layout(height=300, hoverlabel=dict(align='left'))
...
with col2:
    with st.container(border=True):
        ...
        if not df_filtrado_general.empty:
            ...
            fig_sunburst.update_layout(height=300, hoverlabel=dict(align='left'))
    ...
    with st.container(border=True):
        ...
        if not df_filtrado_general.empty:
            ...
            fig_bar.update_layout(
                height=300, hoverlabel=dict(align='left'), coloraxis_showscale=False,
